...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <header className="border-b border-stone-100 sticky top-0 z-30 bg-white/95 backdrop-blur-md">
      ...
      <section className="relative px-4 sm:px-6 lg:px-8 pt-10 pb-12 sm:pb-16">
        <div className="mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <div className="mt-7 flex flex-wrap items-center gap-3">
              ...
              <a href="tel:+919876543210" className="btn-outline rounded-full">
      ...
      <section className="px-4 sm:px-6 lg:px-8 pb-12">
        <div className="mx-auto max-w-7xl rounded-3xl bg-white border border-stone-100 grid grid-cols-2 lg:grid-cols-4 divide-y sm:divide-y-0 sm:divide-x divide-stone-100">
          {features.map((f) => (
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-12 sm:py-16 bg-stone-50/60 border-y border-stone-100">
      ...
      <section className="px-4 sm:px-6 lg:px-8 pb-14">
        <div className="mx-auto max-w-7xl rounded-4xl bg-gradient-to-br from-brand-ink-900 via-brand-green-800 to-brand-green-600 text-white px-6 sm:px-14 py-14 sm:py-20 text-center relative overflow-hidden">
          <div
            aria-hidden
